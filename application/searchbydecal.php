...
if($search_key == "")
{
    ...
    $sql = "SELECT p.plate as permit_plate,
    ...
    FROM permits as p
    JOIN drivers as d  
    WHERE p.num LIKE '%$search_key%' AND p.plate = d.plate;";
}
...
<!--         <div id="content" class="active container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 ml-auto mr-auto">
                    <form class="" id="search_form" action="searchbydecal.php" method="post">
                        <div class="row">
                            <div class="col-md-5">
                                <select name="type" class="form-control" id="search_select">
                                    ...
                                    <option value="decal" selected="selected">decal #</option>
                                </select> 
                            </div>
                            <div class="col-md-5">
