...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if (isset($_POST["save"])) {
        ...
        $sub_department = ucfirst($_POST["department_2"]);
        $supervisor = ucfirst($_POST["supervisor"]);
        $plate = $_POST["plate"];
    ...
    if(isset($_POST["edit"]))
    {
        ...
        $department_2 = $row["sub_department"];
                    ...
                    <form class="form-group" action="edit.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control class="form-control"" type="text" name="last_name" value="<?php echo $last_name ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" autocomplete="off" list="departments" type="text" name="department_2" value="<?php echo $department_2 ?>">
                            </div>
                            <div class="col">
