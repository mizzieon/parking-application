...
{
    $search_key = htmlspecialchars($_POST["plate"]);
}else{
    $search_key = htmlspecialchars($_SESSION["create_plate"]);
}
...
if(isset($_POST["violation"]))
{
    ...
    $target = $plate;
    $actionType = "violation add";
    $details = "A new violation was created for plate: " . $plate;
...
$username = $_SESSION['username'];
$target = $search_key;
$actionType = "record view";
$details = "The record for plate: " . $target . " was accessed";
