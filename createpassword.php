...
<body class="">
  ...
  <div class="row h-100 text-center">
    <div class="col my-auto">
     <form action="includes/createpassword.inc.php" method="POST" class="form-signin no-gutters">
      <h1 class="h3 mb-3 font-weight-normal">Create a password for:</h1>
      <?php
      if (isset($_SESSION['usernameToRegister'])) {
        $usernameToRegister = $_SESSION['usernameToRegister'];
      }else {
        $usernameToRegister = "testing username";
      }
      echo "<h4>" . $usernameToRegister . "</h4>";
      ?>
      ...
      <input type="password" placeholder="Repeat Password" id="repeatPassword" class="form-control mb-3" name="repeatPassword">
      <button type="submit" class="btn btn-lg btn-primary btn-block mb-3" name="passwordSubmit">Submit</button>
